...
public class LihatKategori extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableKategori.setFont(new java.awt.Font("Segoe UI", 1, 17)); // NOI18N
        ...
        tableKategori.setRequestFocusEnabled(false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LihatKategori().setVisible(true);
            }
        });
    }
